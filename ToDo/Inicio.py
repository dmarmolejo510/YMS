...
def News(Datos):
    ...
    try:
        ...
        """
        News = DB.Get_Dato("SELECT * FROM portal.cnoticias WHERE cne_donde = 'Zona 1'")
        Resultado["Contenido"] += """
            <div id="carouselExampleDark" class="carousel carousel_1 carousel-dark slide h-100 d-flex justify-content-center align-items-center" data-bs-ride="carousel" style='box-shadow: rgba(50, 50, 93, 0.25) 0px 30px 60px -12px inset, rgba(0, 0, 0, 0.3) 0px 18px 36px -18px inset;'>
              <div class="carousel-indicators">
        """
        Count = 0
        for N in News:
            if Count == 0:
                Resultado["Contenido"] += '<button type="button" data-bs-target="#carouselExampleDark" data-bs-slide-to="'+str(Count)+'" class="active" aria-current="true"></button>'
            else:
                Resultado["Contenido"] += '<button type="button" data-bs-target="#carouselExampleDark" data-bs-slide-to="'+str(Count)+'"></button>'
            Count += 1
        Resultado["Contenido"] += """
              </div>
        ...
        for N in News:
            if Count == 0:
                ...
                <div class="carousel-item active" data-bs-interval="5000">
                    <div class='w-100 h-100 d-flex justify-content-center align-items-center p-1'>
                        <div class='w-100 h-100'><img onclick='Ver_Imagen(\"http://10.4.7.219:8080/Portal_File/"""+str(N["cne_imagen"])+"""\")' src="http://10.4.7.219:8080/Portal_File/"""+str(N["cne_imagen"])+"""\" class="d-block h-100 w-100"></div>
                    </div>
                """
                if str(N["cne_titulo"]) != "" or  str(N["cne_sub_titulo"]) != "":
                    Resultado["Contenido"] += """
                    <div class="carousel-caption d-none d-md-block" style='background:rgba(255, 255, 255, 0.48)'>
                      <div class='h5'>"""+str(N["cne_titulo"])+"""</div>
                      <div>"""+str(N["cne_sub_titulo"])+"""</div>
                    </div>
                    """
                Resultado["Contenido"] += """
                </div>
                ...
                <div class="carousel-item" data-bs-interval="5000">
                    <div class='w-100 h-100 d-flex justify-content-center align-items-center p-1'>
                        <div class='w-100 h-100'><img onclick='Ver_Imagen(\"http://10.4.7.219:8080/Portal_File/"""+str(N["cne_imagen"])+"""\")' src="http://10.4.7.219:8080/Portal_File/"""+str(N["cne_imagen"])+"""\" class="d-block h-100 w-100" alt="..."></div>
                    </div>
                """
                if str(N["cne_titulo"]) != "" or  str(N["cne_sub_titulo"]) != "":
                    Resultado["Contenido"] += """
        ...
        """
        News = DB.Get_Dato("SELECT * FROM portal.cnoticias WHERE cne_donde = 'Zona 2'")
        Configuracion = DB.Get_Dato("SELECT * FROM portal.cconf_portal")[0]
        Resultado["Contenido"] += """
            <div id="carouselExampleDar_2" class="carousel carousel_2 carousel-dark slide h-100 d-flex justify-content-center align-items-center" data-bs-ride="carousel" style='box-shadow: rgba(50, 50, 93, 0.25) 0px 30px 60px -12px inset, rgba(0, 0, 0, 0.3) 0px 18px 36px -18px inset;'>
              <div class="carousel-indicators">
        """
        Count = 0
        for N in News:
            if Count == 0:
                Resultado["Contenido"] += '<button type="button" data-bs-target="#carouselExampleDar_2" data-bs-slide-to="'+str(Count)+'" class="active" aria-current="true"></button>'
            else:
                Resultado["Contenido"] += '<button type="button" data-bs-target="#carouselExampleDar_2" data-bs-slide-to="'+str(Count)+'"></button>'
            Count += 1
        if int(Configuracion["cportal_bd_ulinc"]) == 1:
            for Imagen in os.listdir(str(PATH_DIR)+"/Files/Comunicacion/Cumples/Ulinc"):
                Resultado["Contenido"] += '<button type="button" data-bs-target="#carouselExampleDar_2" data-bs-slide-to="'+str(Count)+'"></button>'
                Count += 1
        if int(Configuracion["cportal_bd_staff"]) == 1:
            for Imagen in os.listdir(str(PATH_DIR)+"/Files/Comunicacion/Cumples/Staff"):
                Resultado["Contenido"] += '<button type="button" data-bs-target="#carouselExampleDar_2" data-bs-slide-to="'+str(Count)+'"></button>'
                Count += 1
        Resultado["Contenido"] += """
              </div>
        ...
        for N in News:
            if Count == 0:
                ...
                <div class="carousel-item active" data-bs-interval="3500">
                    <div class='w-100 h-100 d-flex justify-content-center align-items-center p-1'>
                        <div class='w-75 h-75'><img src="http://10.4.7.219:8080/Portal_File/"""+str(N["cne_imagen"])+"""\" class="d-block h-100 w-100" alt="..."></div>
                    </div>
                </div>
                """
            else:
        ...
        if int(Configuracion["cportal_bd_ulinc"]) == 1:
            for Imagen in os.listdir(str(PATH_DIR)+"/Files/Comunicacion/Cumples/Ulinc"):
                ...
                <div class="carousel-item" data-bs-interval="3500">
                    <div class='w-100 h-100 d-flex justify-content-center align-items-center p-1'>
                        <div class='w-75 h-75'><img src=\""""+str(request.url_root)+"""/Portal_File/Comunicacion/Cumples/Ulinc/"""+str(Imagen)+"""\" class="d-block h-100 w-100" alt="..."></div>
                    </div>
                </div>
                """
                Count += 1
        if int(Configuracion["cportal_bd_staff"]) == 1:
            for Imagen in os.listdir(str(PATH_DIR)+"/Files/Comunicacion/Cumples/Staff"):
                ...
                <div class="carousel-item" data-bs-interval="3500">
                    <div class='w-100 h-100 d-flex justify-content-center align-items-center p-1'>
                        <div class='w-75 h-75'><img src=\""""+str(request.url_root)+"""/Portal_File/Comunicacion/Cumples/Staff/"""+str(Imagen)+"""\" class="d-block h-100 w-100" alt="..."></div>
                    </div>
                </div>
                """
                Count += 1
